...
public class DirectionInputDetector : BaseInputInformationEditor<EnableDirection>
{
    public DirectionInputDetector(InputDirectionInformation inputInformation, DirectionSettingSO buttonSettingSO) : base(inputInformation)
    {
